...
async function seedRolesAndPermissions() {
  ...
  console.log(
    `Seeded ${PERMISSION_CATALOG.length} permissions (removed ${stalePermissionIds.length} superseded)`,
  );
  ...
  for (const role of ROLE_CATALOG) {
    ...
    for (const permissionKey of role.permissions) {
      ...
      if (!permissionId) {
        throw new Error(
          `Role "${role.name}" grants unknown permission "${permissionKey}" — check PERMISSION_CATALOG`,
        );
      }
...
async function seedAdministrator(roleRecords: Map<string, string>) {
  ...
  console.log(
    'Seeded break-glass Administrator account (admin@ecoswiftbank.com — password reset required before use)',
  );
}
...
async function seedApplicationSettings() {
  const settings = [
    {
      key: 'kyc.tier1.daily_transfer_limit',
      value: '1000.00',
      valueType: 'NUMBER' as const,
      description: 'Daily transfer limit (USD) for Tier 1 KYC customers',
    },
    {
      key: 'kyc.tier2.daily_transfer_limit',
      value: '10000.00',
      valueType: 'NUMBER' as const,
      description: 'Daily transfer limit (USD) for Tier 2 KYC customers',
    },
    {
      key: 'kyc.tier3.daily_transfer_limit',
      value: '100000.00',
      valueType: 'NUMBER' as const,
      description: 'Daily transfer limit (USD) for Tier 3 KYC customers',
    },
    {
    ...
    },
    {
      ...
      value: '5',
      valueType: 'NUMBER' as const,
      description: 'Number of previous passwords disallowed on reuse',
    },
    {
      key: 'session.idle_timeout_minutes',
      value: '15',
      valueType: 'NUMBER' as const,
      description: 'Sliding session inactivity timeout',
    },
    {
      key: 'session.absolute_timeout_hours',
      value: '12',
      valueType: 'NUMBER' as const,
      description: 'Absolute maximum session lifetime',
    },
    {
      key: 'otp.expiry_minutes',
      value: '5',
      valueType: 'NUMBER' as const,
      description: 'OTP challenge validity window',
    },
    {
      key: 'otp.max_attempts',
      value: '5',
      valueType: 'NUMBER' as const,
      description: 'Max verification attempts per OTP challenge',
    },
    {
      key: 'loan.max_debt_to_income_ratio',
      value: '0.4',
      valueType: 'NUMBER' as const,
      description: 'Maximum allowed debt-to-income ratio for loan eligibility',
    },
    {
      key: 'transfer.maker_checker_threshold',
      value: '5000.00',
      valueType: 'NUMBER' as const,
      description: 'Transfer amount (USD) above which maker-checker approval is required',
    },
    ...
    // Phase 3A: Identity & Authentication policy
    {
      ...
      value: '5',
      valueType: 'NUMBER' as const,
      description: 'Max concurrent active sessions per user before the oldest is revoked',
    },
    {
      key: 'account.max_failed_login_attempts',
      value: '5',
      valueType: 'NUMBER' as const,
      description: 'Failed login attempts before LockoutPolicy locks the account',
    },
    {
      key: 'account.lockout_duration_minutes',
      value: '15',
      valueType: 'NUMBER' as const,
      description: 'How long an account stays locked after exceeding max failed attempts',
    },
    {
    ...
    {
      key: 'email_verification.expiry_minutes',
      value: '60',
      valueType: 'NUMBER' as const,
      description: 'Email verification link validity window',
    },
    {
      key: 'password_reset.expiry_minutes',
      value: '30',
      valueType: 'NUMBER' as const,
      description: 'Password reset link validity window',
    },
    {
      key: 'access_token.ttl_minutes',
      value: '15',
      valueType: 'NUMBER' as const,
      description: 'JWT access token lifetime',
    },
    {
      key: 'refresh_token.ttl_days',
      value: '7',
      valueType: 'NUMBER' as const,
      description: 'Refresh token / session lifetime (standard login)',
    },
    {
      key: 'refresh_token.remember_me_ttl_days',
      value: '30',
      valueType: 'NUMBER' as const,
      description: 'Refresh token / session lifetime when "remember me" is selected',
    },
    {
      key: 'mfa.challenge_ttl_minutes',
      value: '5',
      valueType: 'NUMBER' as const,
      description: 'How long an MFA challenge token issued mid-login stays valid',
    },
    {
      key: 'mfa.step_up_ttl_minutes',
      value: '10',
      valueType: 'NUMBER' as const,
      description: 'How long a step-up assertion stays valid after fresh MFA re-verification',
    },
    {
      key: 'mfa.backup_code_count',
      value: '10',
      valueType: 'NUMBER' as const,
      description: 'Number of single-use backup codes issued per MFA enrollment/regeneration',
    },
    {
      key: 'session.suspicious_ip_change_window_minutes',
      value: '5',
      valueType: 'NUMBER' as const,
      description:
        'A new session from a different IP than another still-active session for the same user, within this window, is flagged suspicious',
    },
  ];
...
async function seedSystemSettings() {
  const settings = [
    ...
    {
      key: 'system.default_rate_limit_per_minute',
      value: '100',
      valueType: 'NUMBER' as const,
      description: 'Default API rate limit per client per minute',
    },
    {
      key: 'system.webhook_max_retry_attempts',
      value: '8',
      valueType: 'NUMBER' as const,
      description: 'Max delivery attempts for outbound webhooks',
    },
  ];
...
async function seedFeatureFlags() {
  const flags = [
    ...
    {
      key: 'savings.auto_renewal_enabled',
      name: 'Savings auto-renewal',
      isEnabled: true,
    ...
    {
      key: 'transfers.new_validation_flow',
      name: 'New transfer validation flow',
      isEnabled: false,
      scope: 'GLOBAL' as const,
      rolloutPercentage: 0,
    },
...
async function seedTransactionTypes() {
  const types = [
    ...
    { code: 'WITHDRAWAL', name: 'Withdrawal', description: 'Funds debited from an account' },
    {
      ...
      name: 'Admin Credit',
      description:
        'Funds credited into an account by staff (e.g. opening-balance funding after the fact)',
    },
    {
      code: 'TRANSFER_INTERNAL',
      name: 'Internal Transfer',
      description: 'Transfer between two Ecoswift Bank accounts',
    },
    {
      code: 'TRANSFER_EXTERNAL',
      name: 'External Transfer',
      description: 'Transfer to an account at another institution',
    },
    {
      code: 'LOAN_DISBURSEMENT',
      name: 'Loan Disbursement',
      description: 'Loan principal released to a customer account',
    },
    {
      code: 'LOAN_REPAYMENT',
      name: 'Loan Repayment',
      description: 'Customer repayment applied to an outstanding loan',
    },
    {
      code: 'SAVINGS_CONTRIBUTION',
      name: 'Savings Contribution',
      description: 'Funds moved into a savings plan',
    },
    {
      code: 'INTEREST_POSTING',
      name: 'Interest Posting',
      description: 'Accrued interest realized as a ledger posting',
    },
    { code: 'FEE_CHARGE', name: 'Fee Charge', description: 'A fee applied to a customer account' },
    {
      code: 'REVERSAL',
      name: 'Reversal',
      description: 'A compensating reversal of a prior transaction',
    },
  ];
...
async function seedNotificationTemplates() {
  const templates = [
    ...
    // any other source, per docs/authentication.md § Email Templates.
    {
      ...
      subjectTemplate: 'Welcome to Ecoswift Bank',
      bodyTemplate: readEmailTemplate('welcome.html'),
    },
    {
      code: 'EMAIL_VERIFICATION',
      channel: 'EMAIL' as const,
      subjectTemplate: 'Verify your email address',
      bodyTemplate: readEmailTemplate('email-verification.html'),
    },
    {
      code: 'PASSWORD_RESET_REQUEST',
      channel: 'EMAIL' as const,
      subjectTemplate: 'Reset your password',
      bodyTemplate: readEmailTemplate('password-reset.html'),
    },
    {
      code: 'LOGIN_NEW_DEVICE',
      channel: 'EMAIL' as const,
      subjectTemplate: 'New sign-in to your account',
      bodyTemplate: readEmailTemplate('login-alert.html'),
    },

    {
      ...
      bodyTemplate:
        'Your Ecoswift Bank verification code is {{code}}. It expires in {{expiryMinutes}} minutes. Never share this code.',
    },
    {
      code: 'LOGIN_ALERT_SMS',
      channel: 'SMS' as const,
      bodyTemplate:
        'Ecoswift Bank: new sign-in to your account from {{location}} at {{loginTime}}. Not you? Contact security@ecoswiftbank.com.',
    },
    {
      code: 'TRANSFER_COMPLETED',
      channel: 'PUSH' as const,
      subjectTemplate: 'Transfer completed',
      bodyTemplate: 'Your transfer of {{amount}} {{currency}} to {{recipient}} was completed.',
    },
    {
      code: 'TRANSFER_COMPLETED_EMAIL',
      channel: 'EMAIL' as const,
      subjectTemplate: 'Transfer completed — {{amount}} {{currencyCode}}',
      bodyTemplate: readEmailTemplate('transfer-completed.html'),
    },
    // Wire transfers get their own richer confirmation — full sender/
    // beneficiary bank detail, fee/total breakdown, date+time stamp — since
    // ExternalTransferService has that data and TRANSFER_COMPLETED_EMAIL's
    // one-line summary doesn't read like a real wire receipt.
    {
      code: 'WIRE_TRANSFER_COMPLETED_EMAIL',
      channel: 'EMAIL' as const,
      subjectTemplate: 'Wire transfer confirmation — {{amount}} {{currencyCode}}',
      bodyTemplate: readEmailTemplate('wire-transfer-completed.html'),
    },
    ...
    {
      code: 'TRANSFER_INITIATED_EMAIL',
      channel: 'EMAIL' as const,
      subjectTemplate: 'Transfer received — pending review',
      bodyTemplate: readEmailTemplate('transfer-initiated.html'),
    },
    {
      code: 'TRANSFER_FAILED_EMAIL',
      channel: 'EMAIL' as const,
      subjectTemplate: 'Transfer failed — {{amount}} {{currencyCode}}',
      bodyTemplate: readEmailTemplate('transfer-failed.html'),
    },
    {
      code: 'TRANSFER_CANCELLED_EMAIL',
      channel: 'EMAIL' as const,
      subjectTemplate: 'Scheduled transfer cancelled',
      bodyTemplate: readEmailTemplate('transfer-cancelled.html'),
    },
    {
      code: 'LARGE_TRANSFER_ALERT_EMAIL',
      channel: 'EMAIL' as const,
      subjectTemplate: 'Security alert: large transfer — {{amount}} {{currencyCode}}',
      bodyTemplate: readEmailTemplate('large-transfer-alert.html'),
    },
    {
      code: 'ACCOUNT_FROZEN',
      channel: 'EMAIL' as const,
      subjectTemplate: 'Your account has been frozen',
      bodyTemplate:
        'Account {{accountNumber}} was frozen. Reason: {{reasonCategory}}. Contact support if you believe this is an error.',
    },
    {
      code: 'KYC_APPROVED',
      channel: 'EMAIL' as const,
      subjectTemplate: 'Identity verification approved',
      bodyTemplate: 'Your KYC verification has been approved at tier {{tier}}.',
    },
    {
      code: 'KYC_REJECTED',
      channel: 'EMAIL' as const,
      subjectTemplate: 'Identity verification could not be completed',
      bodyTemplate: 'Your KYC submission was rejected: {{reason}}. Please resubmit.',
    },
    {
      ...
      bodyTemplate:
        "Your password was changed at {{timestamp}}. If this wasn't you, contact security@ecoswiftbank.com immediately.",
    },

    // Phase 3C: MFA / enterprise security.
    {
      code: 'OTP_CHALLENGE_EMAIL',
      channel: 'EMAIL' as const,
      subjectTemplate: 'Your verification code',
      bodyTemplate:
        'Your Ecoswift Bank verification code is {{code}}. It expires in {{expiryMinutes}} minutes. Never share this code with anyone, including Ecoswift Bank staff.',
    },
    {
      code: 'SECURITY_ALERT',
      channel: 'EMAIL' as const,
      ...
      bodyTemplate:
        "{{message}} This happened at {{timestamp}}. If this wasn't you, contact security@ecoswiftbank.com immediately.",
    },
    ...
    // Phase 4A: account opening.
    {
      code: 'ACCOUNT_OPENED',
      channel: 'EMAIL' as const,
      subjectTemplate: 'Your {{accountTypeName}} is open',
      bodyTemplate: readEmailTemplate('account-opened.html'),
    },
    {
      code: 'ACCOUNT_OPENED_SMS',
      channel: 'SMS' as const,
      bodyTemplate:
        'Ecoswift Bank: your {{accountTypeName}} {{accountNumber}} is now open. Welcome aboard!',
    },
    {
      code: 'ACCOUNT_OPENED_PUSH',
      channel: 'PUSH' as const,
      subjectTemplate: 'Account opened',
      bodyTemplate: 'Your {{accountTypeName}} {{accountNumber}} is ready to use.',
    },
  ];
